...
<nav
  ...
  style={{ transformOrigin: "top" }}
>
  <Link to="/" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-green-50">Home</Link>
  <Link to="/products" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-green-50">Products</Link>
  <Link to="/reviews" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-green-50">Reviews</Link>
  <Link to="/contact" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-green-50">Contact</Link>
</nav>
          </div>
        </div>
      </div>
