    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="p-4 flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1 border p-4">
          ...
          {["Sea moss body butter", "Sea moss gel", "Sea moss lip balm"].map((item, idx) => (
            <div key={idx} className="border p-2 flex justify-between items-center mb-2">
              <div>
        ...
        <div className="flex-1 border p-4 mb-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <input type="text" placeholder="First name" className="p-2 bg-gray-100" />
            <input type="text" placeholder="Last name" className="p-2 bg-gray-100" />
            <input type="text" placeholder="Company (optional)" className="col-span-2 p-2 bg-gray-100" />
          ...
          <button className="bg-green-900 text-white px-6 py-2 mt-4 rounded">Pay Now</button>
        </div>
        <Footer />
      </main>
    </div>
